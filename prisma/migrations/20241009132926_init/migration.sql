...
-- CreateIndex
CREATE UNIQUE INDEX "Teacher_img_key" ON "Teacher"("img");
...
-- AddForeignKey
ALTER TABLE "Announcements" ADD CONSTRAINT "Announcements_classId_fkey" FOREIGN KEY ("classId") REFERENCES "Class"("id") ON DELETE SET NULL ON UPDATE CASCADE;
